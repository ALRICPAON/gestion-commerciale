...
function renderSummary(data) {
  ...
  const rows = [
    ...
    ['Achats bruts HT periode', money(k.gross_purchases_ht)],
    ['Avoirs fournisseurs appliques', `-${money(k.supplier_credit_notes_applied_ht)}`],
    ['Achats nets HT periode', money(k.purchases_ht)],
