...
function statusLabel(status) { return ({ draft: "Brouillon", validated: "Validé", cancelled: "Annulé" })[status] || status || "-"; }
function typeLabel(type) { return ({ ORDER: "Commande", DELIVERY_NOTE: "Bon de livraison", INVOICE: "Facture", manual_sale: "Vente manuelle", inventory_sale: "Vente inventaire" })[type] || type || "-"; }
