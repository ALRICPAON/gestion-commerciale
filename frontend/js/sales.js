...
function typeLabel(sale) { return ({ ORDER: "Commande", DELIVERY_NOTE: "Bon de livraison", INVOICE: "Facture", CREDIT_NOTE: "Avoir client", manual_sale: "Vente manuelle", inventory_sale: "Vente inventaire" })[sale.document_type] || sale.document_type || "-"; }
