(function () {
  ...
  function linkedRecordButton(item) {
    const publicType = item.type === 'manual' ? 'manual_task' : item.type;
    return detailButton(publicType, item.source_record_id, 'record');
  }
