...
| `create_quality_cleaning_plan` | quality | `quality/cleaning.saveCleaningPlan` | operational | 1 | `quality.configuration.write` | `quality.configuration.write` | non | `quality_cleaning_plans`, liaisons zones/equipements, `quality_tasks` | n/a | accepte `zone_ids`/`equipment_ids`, compatible legacy |
| `update_quality_cleaning_plan` | quality | `quality/cleaning.saveCleaningPlan` | operational | 1 | `quality.configuration.write` | `quality.configuration.write` | non | `quality_cleaning_plans`, liaisons zones/equipements, `quality_tasks` | n/a | remplace les liaisons actives par les tableaux fournis |
