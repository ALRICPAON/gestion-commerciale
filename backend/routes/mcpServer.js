...
const pendingActionInputSchema = {
  ...
  properties: {
    action_type: {
      type: 'string',
      description: 'Type métier préparé. Pour une commande client, utiliser customer_order_draft.',
    },
    summary: { type: 'string', description: 'Résumé clair à afficher à l’utilisateur avant confirmation.' },
    payload: {
      type: 'object',
      description: 'Payload figé préparé par l’agent. Pour customer_order_draft: client_id, document_date optionnel, notes optionnel, lines[].',
      properties: {
        ...
        lines: {
          ...
          items: {
            type: 'object',
            required: ['sold_quantity', 'unit_sale_price_ht'],
            properties: {
