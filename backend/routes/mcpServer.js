...
const PUBLIC_QUALITY_BLOCK_TOOL_ALIASES = {
  ...
  quality_documentation_update_table_cell: 'quality.documentation.update_table_cell',
  quality_documentation_relink_table: 'quality.documentation.relink_table',
  quality_documentation_update_diagram: 'quality.documentation.update_diagram',
  quality_documentation_relink_diagram: 'quality.documentation.relink_diagram',
};
