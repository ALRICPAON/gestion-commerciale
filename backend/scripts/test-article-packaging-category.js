...
function main() {
  ...
  includes('frontend/sale-detail.html', './css/pages/sale-detail.css?v=5', 'cache-buster css vente attendu');
  includes('frontend/sale-detail.html', './js/sale-detail.js?v=20', 'cache-buster vente attendu');
  ...
  includes('frontend/sale-detail.html', './js/sale-stock-negative-flow.js?v=5', 'cache-buster flux stock negatif attendu');
