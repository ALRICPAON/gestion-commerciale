...
VALUES
  (NULL, '70', 'operating_revenue', 'revenue', 'Chiffre d affaires et produits d exploitation', 1, 10, true),
  ...
  (NULL, '603', 'operating_expenses', 'stock_variation', 'Variation de stocks', -1, 95, true),
  (NULL, '60', 'operating_expenses', 'purchases', 'Achats et variations de stocks', -1, 100, true),
  (NULL, '61', 'operating_expenses', 'external_charges', 'Services exterieurs', -1, 110, true),
  (NULL, '62', 'operating_expenses', 'external_charges', 'Autres services exterieurs', -1, 120, true),
  (NULL, '63', 'operating_expenses', 'taxes', 'Impots et taxes', -1, 130, true),
  (NULL, '64', 'operating_expenses', 'staff_costs', 'Charges de personnel', -1, 140, true),
