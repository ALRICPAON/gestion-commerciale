-- Guard migration for cleaning plans as PMS source of truth.
-- Idempotent and additive: this repeats the required #218 schema extensions so
-- production databases that missed 064 can be repaired without data loss.
