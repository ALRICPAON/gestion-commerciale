...
const tools = [
  ...
  tool({
    ...
    description: 'Prepare l application des lignes reconnues d un import fournisseur vers une session tarification brouillon.',
    domain: 'pricing',
    riskLevel: RISK_LEVELS.LOW_REVERSIBLE_WRITE,
    requiredPermission: 'pricing.write',
    requiresConfirmation: false,
