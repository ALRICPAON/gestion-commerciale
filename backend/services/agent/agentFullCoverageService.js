...
const MODULE_COVERAGE = Object.freeze([
  ...
  { domain: 'articles', read: ['search_articles', 'get_articles_overview', 'get_article_profile'], create: ['prepare_article_draft'], update: ['prepare_article_update', 'prepare_article_price_update'], prepare: [], execute: [] },
  ...
  { domain: 'communications', read: ['get_communications_overview'], create: ['prepare_email_draft', 'prepare_whatsapp_message', 'prepare_sms_message'], update: [], prepare: ['preview_email', 'preview_customer_price_list'], execute: ['send_email_confirmed', 'send_customer_price_list_confirmed'] },
