...
const MODULE_COVERAGE = Object.freeze([
  ...
  { domain: 'pricing', read: ['list_pricing_sessions', 'get_pricing_session', 'get_current_pricing_session', 'list_pricing_lines', 'search_pricing_lines', 'get_article_pricing_history', 'list_tariff_levels', 'list_supplier_price_imports', 'get_supplier_price_import', 'list_supplier_article_mappings'], create: ['prepare_pricing_session_create', 'prepare_pricing_line_add', 'prepare_supplier_price_import', 'prepare_supplier_article_mapping_confirm'], update: ['prepare_pricing_line_update', 'prepare_pricing_line_remove', 'prepare_supplier_import_apply'], prepare: ['prepare_pricing_session_duplicate', 'prepare_pricing_session_publish'], execute: ['execute_pending_action', 'execute_business_action'] },
