...
const ACTIONS = [
  ...
  },
  {
    ...
    description: 'Applique les lignes confirmees ou corrigees humainement d un import fournisseur a une session brouillon, ou cree une revision brouillon si la session cible est publiee et que create_revision_if_published vaut true.',
    aliases: [],
    module: 'pricing',
    requiredPermission: 'pricing.write',
    requiredPermissions: ['mcp.execute', 'pricing.write'],
