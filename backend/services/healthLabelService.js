...
function renderHealthLabelZpl(label) {
  ...
  lines.push(zplZoneBlock(FIXED_TRACE_TOP_ZONE, mm(1), mm(11.5), mm(76), 12, field('Methode', trace.production_method), 1));
  ...
  const tabCol2 = mm(40);
  const tabCol3 = mm(78);
  lines.push(zplZoneBlock(tab, tabCol1, mm(1.5), mm(36), 13, label.article_label || '-', 1));
  lines.push(zplZoneBlock(tab, tabCol1, mm(5), mm(36), 12, trace.latin_name, 1));
  lines.push(zplZoneBlock(tab, tabCol1, mm(8.5), mm(36), 12, field('Methode', trace.production_method), 1));
  lines.push(zplZoneBlock(tab, tabCol1, mm(12), mm(36), 12, field('ALLERGENE', label.allergen_label), 1));
  lines.push(zplZoneBlock(tab, tabCol2, mm(1.5), mm(36), 12, field('ZONE DE PECHE', label.fishing_area_label || trace.fao_zone), 2));
  lines.push(zplZoneBlock(tab, tabCol2, mm(9), mm(17), 12, field('Sous-zone', trace.sous_zone), 1));
  lines.push(zplZoneBlock(tab, mm(59), mm(9), mm(18), 12, field('Engin', trace.fishing_gear), 1));
  lines.push(zplZoneBlock(tab, tabCol2, mm(11.5), mm(36), 12, field('DLC/DDM', formatDate(trace.dlc)), 1));
  lines.push(zplZoneBlock(tab, tabCol3, mm(1.5), mm(38), 12, field('Lot', lot), 1));
  ...
  lines.push(zplZoneBlock(FIXED_TRACE_BOTTOM_ZONE, mm(1), mm(1), mm(34), 13, field('Lot', lot), 1));
  lines.push(zplZoneBlock(FIXED_TRACE_BOTTOM_ZONE, mm(38), mm(1), mm(42), 13, field('DATE DE CONDITIONNEMENT', label.conditioning_date_label || formatDate(label.document_date)), 1));
  ...
  lines.push(zplZoneBlock(FIXED_TRACE_BOTTOM_ZONE, mm(1), mm(5), mm(42), 13, field('CONSERVATION', label.storage_temperature_label), 1));
  lines.push(zplZoneBlock(FIXED_TRACE_BOTTOM_ZONE, mm(47), mm(5), mm(65), 12, field('MENTION', label.storage_instruction_label), 1));
