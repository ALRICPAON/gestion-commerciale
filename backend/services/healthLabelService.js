...
function renderHealthLabelZpl(label) {
  ...
  lines.push(zplZoneBlock(FIXED_TRACE_BOTTOM_ZONE, mm(42), mm(1), mm(42), 13, field('DATE DE CONDITIONNEMENT', label.conditioning_date_label || formatDate(label.document_date)), 1));
